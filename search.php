...
<?php
    ...
    // you can set minimum length of the query if you want
      // if query length is more or equal minimum length then
        ...
        $raw_results = mysql_query("SELECT * FROM verified
  ...
  echo'<div class="col-sm-4 col-md-4 col-lg-4">';
   ...
   echo'<div class="caption">';
    ...
    echo '<img src="data:image/jpeg;base64,'.base64_encode( $results['image'] ).'" width="290" height="290">';
   echo'</div>';
   echo'</div>';
   echo'</div>';
...
echo'</div>';  
            ...
            echo "<br><br>";
            echo "<p style='color:blue; background-color:lightblue;font-size:50px;font-family:Comic Sans MS;text-align:center;'>";
            echo "No results!!" ;
            echo "</p>";
